...
@blueprint_house_orders.route('/get_orders', methods=['GET'])
# @jwt_required()
def house_orders():
...
@blueprint_house_orders.route('/get_order_items/<int:order_id>', methods=['GET'])
# @jwt_required()
...
@blueprint_house_orders.route('/get_active_order', methods=['GET'])
# @jwt_required()
def active_order():
...
@blueprint_house_orders.route('/update_order_item_price/<int:order_item_id>/<string:price>', methods=['PUT'])
# @jwt_required()
...
@blueprint_house_orders.route('/update_order_item_quantity/<int:order_item_id>/<int:quantity>', methods=['PUT'])
# @jwt_required()
